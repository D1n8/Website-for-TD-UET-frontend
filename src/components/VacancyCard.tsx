...
export const VacancyCard = (props: IVacancyCard) => {
  ...
  const employment = parseEmploymentType(props.employment_type);
  const experience = parseExperienceType(props.experience_type);
  ...
  return (
    <div className="vacancy-card">
      <div className="vacancy-card__container">
        ...
        <p className="vacancy-card__employment">Занятость: {employment}</p>
        <p className='vacancy-card__experience'>Опыт работы: {experience}</p>
        ...
        <div className="btns-container">
          ...
          { role !== 'admin' && <button className="btn btn_submit" onClick={() => setIsOpen(true)}>Откликнуться</button> }
        </div>
